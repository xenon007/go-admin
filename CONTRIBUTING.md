...
See [manual](https://github.com/xenon007/go-admin/projects/3) for more information.
...
For now, you need to add your fork as a remote on the original **\$GOPATH**/src/github.com/xenon007/go-admin clone, so:

```bash

$ go get github.com/xenon007/go-admin
$ cd $GOPATH/src/github.com/xenon007/go-admin # GOPATH is $HOME/go by default.
...
Notice: `go get` return `package github.com/xenon007/go-admin: no Go files in /go/src/github.com/xenon007/go-admin` is normal.
...
* [Tasks](https://github.com/xenon007/go-admin/projects)
