...
在这里：[功能规划](https://github.com/xenon007/go-admin/projects/3) 可以获得更多信息。
...
然后，你需要fork远程的master分支到你本地 **\$GOPATH**/src/github.com/xenon007/go-admin ：
...
注意了： `go get` 返回 `package github.com/xenon007/go-admin: no Go files in /go/src/github.com/xenon007/go-admin` 是正常的。
